        ...
        <>
            <div className="bg-gradient-radial from-red-300 to-red-900 bg-fixed">
                <div className="top-0 left-0 text-center w-60 h-4">
                    <h1 className="text-black bg-lago rounded-md">ficha de personagem</h1>
                </div>
                <div className="container mx-auto my-3 text-center md:my-10">
                    <div className="caixaAtributo">
                        <h1 className="md:text-lg">Força: {isForcPositive + forcNumb}</h1>
                    ...
                    <div className="caixaAtributo">
                        <h1 className="md:text-lg">Destreza: {isDexPositive + dexNumb}</h1>
                    ...
                    <div className="caixaAtributo">
                        <h1 className="md:text-lg">Constituição: {isConPositive + conNumb}</h1>
                    ...
                    <div className="caixaAtributo">
                        <h1 className="md:text-lg">Sabedoria: {isSabPositive + sabNumb}</h1>
                    ...
                    <div className="caixaAtributo">
                        <h1 className="md:text-lg">Inteligência: {isIntPositive + intNumb}</h1>
                    ...
                    <div className="caixaAtributo">
                        <h1 className="md:text-lg">Carisma: {IsCarPositive + carNumb}</h1>
