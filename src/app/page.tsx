                ...
                <div className="w-56 mx-auto">
                    <div className="caixaHabilidade">
                        ...
                        <div className="inline-block float-right my-1">
                            <input type='checkbox' className='mx-2 z-10 w-5 cursor-pointer' name="habProefAcro"></input>
                            <input type='checkbox' className='z-20 top-1 left-40 absolute cursor-pointer' name="habExpAcro"></input>
                    ...
                    <div className="caixaHabilidade">
                        ...
                        <div className="inline-block float-right my-1">
                            <input type='checkbox' className='mx-2 z-10 w-5 cursor-pointer'name="habProefPres"></input>
                            <input type='checkbox' className='z-20 top-1 left-40 absolute cursor-pointer'name="habExpPres"></input>
                            <h1 className="inline-block mx-1">+5</h1>
                        </div>
                    </div>
                    <div className="caixaHabilidade">
                        ...
                        <div className="inline-block float-right my-1">
                            <input type='checkbox' className='mx-2 z-10 w-5 cursor-pointer'name="habProefFurt"></input>
                            <input type='checkbox' className='z-20 top-1 left-40 absolute cursor-pointer'name="habExpFurt"></input>
                            <h1 className="inline-block mx-1">+5</h1>
                        </div>
                    </div>
                    <div className="caixaHabilidade">
